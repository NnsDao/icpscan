  ...
  mounted() {
     ...
     */
      ...
      try {
          ...
          chart.raiseCriticalError(new Error("Please download the latest <a href=\"https://www.amcharts.com/download/download-v4/\">amcharts geodata</a> and extract its contents into the same directory as your amCharts files."));
      }


      var label = chart.createChild(am4core.Label)
      label.text = "ICP Data Centers. \nNnsDao.";
      label.fontSize = 12;
      label.align = "left";
      label.valign = "bottom"
      ...
      dataSource.text = "Data source: InternetComputer";
    ...
    //     `https://ic-api.internetcomputer.org/api/boundary-node-locations`
    //   ).then(rsp => rsp.json())
