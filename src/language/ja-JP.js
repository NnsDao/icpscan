export default  {
    ...
    'iNnsDaoToken':'NnsDao Protocol : は、NnsDaoコミュニティのためのDAOガバナンス・パスで、将来の発行枚数は1億枚、暫定価格は1NDPあたり0.15 USDT です。開発者がNnsDaoのエコシステムを構築するために、早期の寄付を受け付けており、また、コミュニティに貢献してくださる皆様を応援しています。',
