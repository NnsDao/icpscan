export default  {
    ...
    'iOstatusFail': '交易失败' ,
    'iBlockHeight': '区块高度' ,
    'iTransferStatus': '转账状态' ,
    'iTransferToken': '转账金额' ,
    'iFee': '手续费' ,

    //detail 
    'iType': '交易类型' ,
    'iTransactionInfo': '转账详细信息' ,
    'iSymbol': '通证类型' ,
    'iTimestamp': '交易时间' ,
    'iFromAddress': '发送方' ,
    'iToAddress': '接受方' ,
    ...
    'iTransfer': '转账' ,
    'iAccountDetail':'账户详情',
    'iAccountAddress':'账户地址',
    'iAccountValue':'账户余额',


    //rank
    'iAllRank':'ICP持币地址前100名排行',
    'iRanking':'名次',
